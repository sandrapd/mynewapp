		...
		function initmodel() {
			vm.gridOptions = {
				...
				columnDefs: [{
					...
					field: 'options',
					cellTemplate: '<div class="btn-group btn-group-toggle" data-toggle="buttons"><button class="btn btn-outline-info btn-sm" style="border:none" type="button" ng-click="row.entity.editItem(row.entity)"><i class="fas fa-pencil-alt"></i></button><button class="btn btn-outline-danger btn-sm" style="border:none" type="button" ng-click="row.entity.removeItem(row.entity)"><i class="fas fa-trash"></i></button></div>'
				}],
				data: []
			};
			vm.gridOptions2 = {
